/* empty css                          */
import { d as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, b as renderComponent, g as renderSlot } from '../astro_WASpLENQ.mjs';
import 'kleur/colors';
import 'clsx';
import { $ as $$Layout } from './_forumName__BMFkeHGO.mjs';

const $$Astro$1 = createAstro();
const $$FormRegister = createComponent(($$result, $$props, $$slots) => {
...
const $$RegisterLayout = createComponent(($$result, $$props, $$slots) => {
